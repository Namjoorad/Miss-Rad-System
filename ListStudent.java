...
import com.example.mashreghi.rad.adapters.MyAdapterName;
...
public class ListStudent extends AppCompatActivity {
    ...
    MyAdapterName myAdapterNames;
    ArrayList<Student> students;
    FloatingActionButton floatingActionButton;
    SwipeRefreshLayout swipeRefreshLayout;
    EditText edtname, edtfamily,edtstunumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtstunumber= findViewById(R.id.edtstunumber);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Student student = new Student(edtname.getText().toString(), edtfamily.getText().toString(),edtstunumber.getText().toString());
    ...
    public void AddtoJSON(View view) {
        ...
        try {
            ...
            object.put("idnumber", Integer.valueOf(edtstunumber.getText().toString()));
            array.put(object);
    ...
    public void Showlist(View view) {
        ...
        myAdapterNames = new MyAdapterName(getApplicationContext(),stu,edtname,edtfamily,edtstunumber);
